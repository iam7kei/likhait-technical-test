...
const HistoryPage: React.FC = () => {
    const [fetchedCategoryData, setFetchedCategoryData] = useState<Category[]>([])
    const [expenses, setExpenses] = useState<Expense[]>([]);
    const [loading, setLoading] = useState(true);
    const [isModalOpen, setIsModalOpen] = useState(false);
    const [isCategoryModalOpen, setIsCategoryModalOpen] = useState<boolean>(false);
    const [initialExpenseData, setInitialExpenseData] = useState<Partial<ExpenseFormData>>({})
    ...
    const fetchCategoryData = async () => {
        try {
            ...
            setFetchedCategoryData(data as Category[])
        } catch (error) {
            console.error("Error fetching expenses:", error);
        } finally {
            setLoading(false);
    ...
    const handleOnAddExpenseCancel = () => {
        ...
        <div style={pageStyle}>
            ...
            >
                <ExpenseForm
                    ...
                    initialCategoryData={fetchedCategoryData || []}
                    onSubmit={handleAddExpense}
                    onCancel={handleOnAddExpenseCancel}
                />
            </Modal>
