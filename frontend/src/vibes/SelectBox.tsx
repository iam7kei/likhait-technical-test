...
import { SelectBoxOptionsType } from "../types";
...
export function SelectBox({
    ...
    const isActionOption: React.CSSProperties = {
    ...
    return (
        <div style={containerStyle}>
            ...
            <select style={selectStyle} {...props}>
                ...
                {options.map((option) => (
                    <option key={option.value} value={option.value} style={option.isAction ? isActionOption : {}}>
                        {option.label}
                    </option>
                ))}
            </select>
